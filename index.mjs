...
/**
  ...
  * @returns 错误代码
  */
export const update = async (user, options = {}) => {
  const token = await getToken(options);
...
/**
  ...
  * @returns 错误代码
  */
export const create = async (user, options = {}) => {
  const token = await getToken(options);
...
/**
  ...
  * @returns 成员
*/
export const get = async (userid, options = {}) => {
  const token = await getToken(options);
...
/**
  ...
  * @returns userid
  */
export const getUserId = async (mobile, options = {}) => {
  const token = await getToken(options);
...
/**
  ...
  * @returns 成员详情
  */
export const getUserByMobile = async (mobile, options = {}) => {
...
/**
  ...
  * @param {*} value 
  */
export const attachTextExtAttrTo = (target, name, value) => {
  if (!target.extattr) {
    target.extattr = {
      attrs: [],
    }
...
/**
  ...
  * @returns 
  */
export const getExtAttrFrom = (target, name) => {
...
/**
  ...
  * @returns 
  */
export const changeMainDepartment = async (userid, newDeptId, options = {}) => {
